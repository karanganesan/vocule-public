...
this repository is where issues, questions and feedback about [vocule](https://www.npmjs.com/package/vocule) live. vocule's source code is not open source; the package, its documentation and its benchmarks are on npm:
